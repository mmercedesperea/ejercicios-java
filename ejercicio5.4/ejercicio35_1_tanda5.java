...
public class ejercicio35_1_tanda5{
  public static void main (String[] args){
    
    int altura=0;
    
    System.out.println("Vamos a pintar una X, para ello dame la altura");
    ...
    if (((altura%2)!=0) && (altura>=3)){
      ...
      //esto pinta el asterisco de en medio de las dos piramides

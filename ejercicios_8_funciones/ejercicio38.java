...
public class ejercicio38 {
   ...
   //rellenar un array 
    ...
    // vamos a mostrar los capicuas
    
      int[] p = (funciones.funciones_array.filtraCapicuas(a));     // este array se generara con los valores indicados y segun lo especificado en la funcion destinada a ello
    
    System.out.print("Su array de capicuas es : \n");
    //muestra el array
